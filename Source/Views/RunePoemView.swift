...
struct RunePoemsView_Previews: PreviewProvider {
    static var previews: some View {
        let sampleRunePoem = RunePoemOld(Name: "RÚNALÉOÐ", Origin: "Anglo-Saxon", Text: "Feoh biþ frófor · fira gehwilcum; sceal þéah mann gehwilc · miclan hit dælan gif hé wille for dryhtne · dómes hléotan.", Translation: RunePoemTranslations(English: "Wealth is a comfort to every man, although every man must share it out greatly if he would obtain a portion of the Lord’s glory.", Russian: "Богатство — утешение всем людям, но должен человек каждый — щедро им делиться, если он хочет перед Господом славу обрести."), Notes: nil)
